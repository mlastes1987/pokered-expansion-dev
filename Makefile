...
pokered-expansion-dev_obj        := $(rom_obj:.o=_red.o)
pokeblue-expansion-dev_obj       := $(rom_obj:.o=_blue.o)
...
tidy:
	$(RM) $(roms) \
	      ...
	      $(pokered-expansion-dev_obj) \
	      $(pokeblue-expansion-dev_obj) \
	      $(pokered_vc_obj) \
	      $(pokeblue_vc_obj) \
	      $(pokeblue_debug_obj) \
	      rgbdscheck.o
...
$(pokered-expansion-dev_obj):        RGBASMFLAGS += -D _RED
$(pokeblue-expansion-dev_obj):       RGBASMFLAGS += -D _BLUE
...
$(foreach obj, $(pokered-expansion-dev_obj), $(eval $(call DEP,$(obj),$(obj:_red.o=.asm))))
$(foreach obj, $(pokeblue-expansion-dev_obj), $(eval $(call DEP,$(obj),$(obj:_blue.o=.asm))))
...
pokered-expansion-dev_pad        = 0x00
pokeblue-expansion-dev_pad       = 0x00
pokered_vc_pad     = 0x00
pokeblue_vc_pad    = 0x00
pokeblue_debug_pad = 0xff

pokered-expansion-dev_opt        = -jsv -n 0 -k 01 -l 0x33 -m MBC3+RAM+BATTERY -r 03 -t "POKEMON RED"
pokeblue-expansion-dev_opt       = -jsv -n 0 -k 01 -l 0x33 -m MBC3+RAM+BATTERY -r 03 -t "POKEMON BLUE"
